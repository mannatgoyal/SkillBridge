...
export const Button: React.FC<ButtonProps> = ({
    ...
    const variants = {
        ...
        secondary: "bg-secondary hover:bg-secondary-hover text-white shadow-lg shadow-secondary/25 focus:ring-secondary",
        ghost: "bg-transparent hover:bg-surface-hover text-text-main hover:text-white",
